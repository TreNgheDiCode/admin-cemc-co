"use client";
import useCtrlKShortcut from "@/hooks/use-search-shortcut";
...
const SearchModalContext = createContext<ModalContextType | undefined>(
  undefined
);
...
export const SearchModalContent = ({
  ...
  return <div className={cn("p-4 pt-10", className)}>{children}</div>;
};
